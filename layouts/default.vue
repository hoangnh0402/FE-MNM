<template>
  <div class="min-h-screen flex bg-gradient-cyber">
    <!-- Sidebar -->
    <aside class="w-64 glass-card m-4 rounded-xl p-6 flex flex-col border border-primary/20">
      <!-- Logo/Brand -->
      <div class="mb-8">
        <h1 class="text-2xl font-bold text-neon flex items-center gap-2">
          <Zap class="w-7 h-7" />
          <span>Smart City</span>
        </h1>
        <p class="text-xs text-gray-500 mt-1 ml-9">IoT Dashboard</p>
      </div>
      ...
      <nav class="flex-1 space-y-2">
        <NuxtLink
          ...
          inactive-class="text-gray-400 hover:bg-dark-lighter hover:text-gray-200"
        >
      ...
      <div class="mt-auto pt-6 border-t border-dark-border">
        <div class="flex items-center gap-3 px-4 py-2">
          ...
          <div>
            ...
            <p class="text-xs text-gray-600">System Operator</p>
          </div>
        </div>
      </div>
    </aside>
    ...
    <div class="flex-1 flex flex-col min-h-screen">
      ...
      <header class="glass-card m-4 mb-0 rounded-xl p-4 flex items-center justify-between border border-primary/10">
        <div>
          ...
          <p class="text-sm text-gray-500">Real-time monitoring & analytics</p>
        </div>
