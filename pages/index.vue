  ...
  <div class="space-y-6">
    ...
    <div>
      <h3 class="text-lg font-semibold text-gray-200 mb-4 flex items-center gap-2">
        ...
        Edge Node Status
        <span class="text-sm text-gray-500 ml-2">({{ onlineNodes.length }}/{{ edgeNodes.length }} online)</span>
      </h3>
      ...
      <div v-else class="glass-card p-8 text-center">
        <AlertCircle class="w-12 h-12 text-gray-600 mx-auto mb-3" />
        <p class="text-gray-500">No edge nodes configured</p>
      </div>
    </div>
    ...
    <div>
      <h3 class="text-lg font-semibold text-gray-200 mb-4 flex items-center gap-2">
        ...
        Data Ingestion Rate
        <span v-if="lastUpdate" class="text-xs text-gray-600 ml-2">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
        ...
        <div>
          ...
          <div class="flex items-center justify-center gap-2">
            ...
            <p class="text-lg font-semibold text-gray-300">Healthy</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Error Display -->
    <div v-if="error" class="glass-card p-4 border-red-500/40 bg-red-500/10">
